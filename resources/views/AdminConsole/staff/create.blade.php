					...
					<div class="col-12 col-md-6 col-lg-6">
						<div class="card">
							<div class="card-body">
                                ...
                                @php
                                    $_canGrantCloseDiscontinue = \App\Models\Staff::canGrantCloseDiscontinueMatterPermission(
                                        $_emailDeleteGrantActor instanceof \App\Models\Staff ? $_emailDeleteGrantActor : null
                                    );
                                @endphp
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="d-flex align-items-center mb-0">
                                        <input type="checkbox" name="can_close_discontinue_matter" value="1" class="me-2"
                                            @if(old('can_close_discontinue_matter')) checked @endif>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" name="legal_practitioner_number" id="legal_practitioner_number" value="{{ old('legal_practitioner_number') }}" class="form-control" placeholder="Enter practising certificate number">
											</div>
										</div>
									</div>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group mb-0">
									...
									<textarea class="form-control tinymce-editor-full staff-email-signature" name="email_signature" id="email_signature">{{ old('email_signature') }}</textarea>
