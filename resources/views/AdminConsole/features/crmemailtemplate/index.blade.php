									...
									<tr id="id_{{@$list->id}}">
										...
										<td class="text-nowrap">
											<div class="dropdown d-inline-block">
												...
												<ul class="dropdown-menu dropdown-menu-end" aria-labelledby="crmTplAction_{{ $list->id }}">
													<li><a class="dropdown-item has-icon" href="{{route('adminconsole.features.crmemailtemplate.edit', base64_encode(convert_uuencode(@$list->id)))}}"><i class="far fa-edit"></i> Edit</a></li>
