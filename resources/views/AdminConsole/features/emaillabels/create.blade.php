												...
												<div class="col-12 col-md-6 col-lg-6">
													<div class="form-group"> 
														...
														<div class="input-group">
															<input type="color" name="color" class="form-control" id="colorPicker" value="{{ old('color', '#3A6FA8') }}" style="height: 38px;" required>
															<input type="text" name="color_hex" class="form-control" id="colorHex" value="{{ old('color', '#3A6FA8') }}" placeholder="#3A6FA8" pattern="^#[0-9A-Fa-f]{6}$" required>
														</div>
														<small class="form-text text-muted">Select a color or enter hex (e.g. theme accent <code class="text-muted">#3A6FA8</code>)</small>
														@if ($errors->has('color'))
															<span class="custom-error" role="alert">
