...
<div id="matteremailmodal"  data-backdrop="static" data-keyboard="false" class="modal fade custom_modal" tabindex="-1" role="dialog" aria-labelledby="clientModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" name="appkicationsendmail" id="appkicationsendmail" action="{{URL::to('/crm/matter/sendmail')}}" autocomplete="off" enctype="multipart/form-data">
				@csrf
					...
					<div class="row">
						...
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
								...
								<select data-valid="" class="form-control crm-ts-plain selectmattertemplate" name="template">
