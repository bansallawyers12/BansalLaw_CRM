...
$docType = $docList ? $docList->cp_checklist_name : ($appdoc->file_name ?? 'Document');
		...
		foreach($doclists as $doclist){
			...
			$doclistdata .= '<tr id="">';
				$doclistdata .= '<td><i class="fa-solid fa-file"></i> '. $doclist->file_name.'<br>'.@$docdata->cp_checklist_name.'</td>';
				$doclistdata .= '<td>';
			...
			$doclistdata .= '<td>';
			if($docStatus == 1){
				$doclistdata .= '<span class="check"><i class="fa-solid fa-eye"></i></span>';
			}
		...
		$checklistItems = $clientMatterId ? CpDocChecklist::where('client_matter_id', $clientMatterId)->get() : collect();
			...
			foreach($checklistItems as $checklistItem){
				...
				$checklistdata .= '<tr>';
				if($appcount >0){
					$checklistdata .= '<td><span class="check"><i class="fa-solid fa-check"></i></span></td>';
				}else{
