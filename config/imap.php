...
return [
    ...
    */
    'accounts' => [
        ...
        'default' => [// account identifier
            ...
            'username' => env('IMAP_USERNAME', 'admin@bansallawyers.com.au'),
    ...
    */
    'options' => [
        'delimiter' => '/',
        'fetch' => 1, // \Webklex\PHPIMAP\IMAP::FT_PEEK,
    ...
    */
    'events' => [
        "message" => [
            'new' => null, // \Webklex\IMAP\Events\MessageNewEvent::class,
            'moved' => null, // \Webklex\IMAP\Events\MessageMovedEvent::class,
            'copied' => null, // \Webklex\IMAP\Events\MessageCopiedEvent::class,
            'deleted' => null, // \Webklex\IMAP\Events\MessageDeletedEvent::class,
            'restored' => null, // \Webklex\IMAP\Events\MessageRestoredEvent::class,
        ],
        "folder" => [
            'new' => null, // \Webklex\IMAP\Events\FolderNewEvent::class,
            'moved' => null, // \Webklex\IMAP\Events\FolderMovedEvent::class,
            'deleted' => null, // \Webklex\IMAP\Events\FolderDeletedEvent::class,
        ],
        "flag" => [
            'new' => null, // \Webklex\IMAP\Events\FlagNewEvent::class,
            'deleted' => null, // \Webklex\IMAP\Events\FlagDeletedEvent::class,
        ],
    ],
    ...
    */
    'masks' => [
        'message' => null, // \Webklex\PHPIMAP\Support\Masks\MessageMask::class,
        'attachment' => null // \Webklex\PHPIMAP\Support\Masks\AttachmentMask::class
    ]
];
